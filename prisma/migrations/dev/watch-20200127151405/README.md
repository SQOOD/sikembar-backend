# Migration `watch-20200127151405`

This migration has been generated at 1/27/2020, 3:14:08 PM.
...
CREATE UNIQUE INDEX `Budget_report_finance` ON `sikembar_test`.`Budget`(`report_finance`)
```
