# Migration `20200209215648-initial`

This migration has been generated at 2/9/2020, 9:56:48 PM.
...
CREATE TABLE `sikembar_test`.`Budget` (
    `detail` varchar(191)   ,
    `id` varchar(191) NOT NULL  ,
    `report_finance` varchar(191) NOT NULL ,
    `value` int   ,
    PRIMARY KEY (`id`)
) 
DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
CREATE TABLE `sikembar_test`.`Procurement` (
    ...
    `report_good` varchar(191) NOT NULL ,
    `spec` varchar(191)   ,
    `tkdn` int   ,
...
CREATE TABLE `sikembar_test`.`GoodPicture` (
    `good` varchar(191) NOT NULL ,
    `id` varchar(191) NOT NULL  ,
...
ALTER TABLE `sikembar_test`.`ReportFinance` ADD FOREIGN KEY (`user`) REFERENCES `sikembar_test`.`User`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`ReportGood` ADD FOREIGN KEY (`user`) REFERENCES `sikembar_test`.`User`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Budget` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Supply` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`CapitalBudget` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Cashflow` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Assumption` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Fuel` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`CostOfGood` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Investment` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`OtherFinance` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`LostProfit` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Royalty` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`OperationCost` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`StateRevenue` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Balance` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`SourceOfFunding` ADD FOREIGN KEY (`report_finance`) REFERENCES `sikembar_test`.`ReportFinance`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Procurement` ADD FOREIGN KEY (`report_good`) REFERENCES `sikembar_test`.`ReportGood`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`Good` ADD FOREIGN KEY (`user`) REFERENCES `sikembar_test`.`User`(`id`) ON DELETE RESTRICT

ALTER TABLE `sikembar_test`.`GoodPicture` ADD FOREIGN KEY (`good`) REFERENCES `sikembar_test`.`Good`(`id`) ON DELETE RESTRICT
```
